                    ...
                    <div class="pl-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <center><input type='submit' name='vehicle_upd' value='UPDATE VEHICLE' class="btn btn-md btn-primary" style="background:#52616B;"><input type='submit' name='vehicle_del' value='DELETE VEHICLE' class="btn btn-md btn-primary" style="background:#52616B;"></center>
                            </div>
                        </div>
                    </div>
                </form>
