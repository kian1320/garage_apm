           				...
           				<div class="row">
            				<div class="col-lg-6">
            					<div class="form-group">
					            	<label class="form-control-label" for="input-first-name">Date</label><br>
            				...
            				<div class="col-lg-12">
            					<div class="form-group">
									...
									<input type='hidden' name='estimated_day'  id='estimated_day' placeholder='Enter Estimated Day' value='0' readonly>
           							...
           							<center><input type='submit' name='records_add2' value='ADD RECORD' class="btn btn-lg btn-primary" style="background:#52616B;"></center>
        						</div>
            				</div>
            			</div>
                  	</div>
