	            		...
	            		<div class="row">
	            			...
	            			<div class="col-lg-12">
	            				<div class="form-group">
									...
									<center><input type='submit' name='record_upd3' value='UPDATE RECORD' class="btn btn-lg btn-primary" style="background:#52616B;"><input type='submit' name='record_del3' value='DELETE RECORD' class="btn btn-lg btn-primary" style="background:#52616B;"></center>
	        					</div>
	            			</div>
	            		</div>
	            	</div>
