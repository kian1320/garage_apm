                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="input-user-name">New Password</label>
                                    <input type="password" id="input-user-name" class="form-control w-50" placeholder="Enter new password" name="new_password" required >
                                </div>
                            </div>
                             <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <center><input type='submit' name='password_update' value='UPDATE PASSWORD' class="btn btn-lg btn-primary" style="background:#52616B;"></center>
                            </div>
                        </div>
                    </div>
                </form>
